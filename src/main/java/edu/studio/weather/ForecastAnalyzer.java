...
public class ForecastAnalyzer {
    ...
    public List<List<String>> calculateMigranePeriodsPrecise(HourlyData hourlyData) {
        ...
        List<String> hourlyTimes = hourlyData.getTime();
        List<Double> hourlyPressure = hourlyData.getPressure_msl();
        // List<String> hourlyTimes = Arrays.asList("2024-04-23T05:00", "2024-04-23T06:00", "2024-04-23T07:00",
        // "2024-04-23T08:00", "2024-04-23T09:00", "2024-04-23T10:00", "2024-04-23T11:00", "2024-04-23T12:00",
        // "2024-04-23T13:00", "2024-04-23T14:00");
        // List<Double> hourlyPressure = Arrays.asList(1013.6, 1013.5, 1013.5, 1008.0, 1011.1, 1013.0, 1010.6, 1010.8,
        // 1000.7);
        //
        int lengthOfTimePressureData = hourlyTimes.size();
