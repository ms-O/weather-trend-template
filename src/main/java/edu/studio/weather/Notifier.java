    ...
    public void notifyUsers(List<List<String>> triggerTimes) {
        ...
        if (triggerTimes.size() > 0) {
            ...
            for (List<String> triggerInterval : triggerTimes) {
                ...
                String messageToDisplay = "Attention!!! Migrane Warning!!! The pressure " + "will drop by "
                        + pressureDrop + " from " + startTimeToShow + " to " + endTimeShow + ". Exercise caution!!!";
            ...
            System.out.println(
                    "Based on our analysis, there are zero migrane triggerring presure drops in the next 7 days.");
        }
