...
public class ForecastTest {
    ...
    @Test
    public void testCalculateMigranePeriodsZero() {
    ...
    @Test
    public void testCalculateMigranePeriodsOne() {
        ...
        List<String> mockTimes = Arrays.asList(
                ...
                "2024-04-23T10:00",
                "2024-04-23T11:00");
        List<Double> mockPressures = Arrays.asList(1010.0, 1005.0, 1000.0, 1002.0, 1004.1, 1002.0, 1002.1);
        ...
        assertEquals(1, result.size()); // We expect 0 trigger period
    }
    ...
    public void testCalculateMigranePeriodsPrecise() {
        ...
        List<String> mockTimes = Arrays.asList(
                ...
                "2024-04-23T13:00",
                "2024-04-23T14:00");
        List<Double> mockPressures = Arrays.asList(1013.6, 1013.5, 1013.5, 1008.0, 1011.1, 1013.0, 1013.6, 1014.8,
                1019.7);
    ...
    @Test
    public void testFromMain_Valid_Integration() {
        String[] args = {};
